...
datas = [
    ...
    (home+'lib/servers_BTC.json', 'electroncash'),
    (home+'lib/servers_BTC_testnet.json', 'electroncash'),
    (home+'lib/checkpoints.json', 'electroncash'),
    (home+'lib/checkpoints_testnet.json', 'electroncash'),
